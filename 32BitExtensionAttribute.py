...
"""
this code will run through all installed apps, which are locally installed, listing all 32bit apps
"""

#THIS IS NOT MINE - SOME WONDERFUL MAN ON JAMF NATION WITH THE NAME OF tlarkin WROTE THIS
